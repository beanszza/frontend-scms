  ...
  return (
    <div className="w-full min-h-full py-xl px-lg md:px-xl space-y-2xl animate-page-in">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between py-2">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            disabled={compiling}
            className="inline-flex items-center justify-center gap-2 px-4 h-10 text-xs font-semibold text-white bg-primary hover:bg-primary/90 disabled:opacity-50 rounded-xl transition-all shadow-sm active:scale-[0.98]"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Card 1: Active Items */}
        <div className="bg-card p-5 rounded-2xl border border-border/80 shadow-sm flex flex-col justify-between hover:border-border transition-all">
        ...
        <div className="bg-card p-5 rounded-2xl border border-border/80 shadow-sm flex flex-col justify-between hover:border-rose-200 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
              Low Stock Alerts
            </span>
        ...
        <div className="bg-card p-5 rounded-2xl border border-border/80 shadow-sm flex flex-col justify-between hover:border-emerald-200 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
        ...
        <div className="bg-card p-5 rounded-2xl border border-border/80 shadow-sm flex flex-col justify-between hover:border-indigo-200 transition-all">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">
              Active Suppliers
            </span>
        ...
        <div className="bg-card p-6 rounded-2xl border border-border/80 shadow-sm flex flex-col justify-between">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4">
            ...
            <div className="flex items-center gap-3 text-xs font-semibold shrink-0 whitespace-nowrap">
              <div className="flex items-center gap-1.5 whitespace-nowrap">
                ...
                <span className="text-foreground whitespace-nowrap">Stock In</span>
              </div>
              <div className="flex items-center gap-1.5 whitespace-nowrap">
                <span className="w-2.5 h-2.5 rounded-full bg-indigo-500 inline-block shrink-0"></span>
                <span className="text-foreground whitespace-nowrap">Consumption</span>
              </div>
            </div>
          </div>
          ...
          <div className="w-full h-48 relative pt-2">
            <svg className="w-full h-full overflow-visible" viewBox="0 0 500 180" preserveAspectRatio="none">
              ...
              {/* Grid Lines */}
              <line x1="0" y1="30" x2="500" y2="30" stroke="currentColor" className="text-muted-foreground" strokeDasharray="4 4" />
              <line x1="0" y1="80" x2="500" y2="80" stroke="currentColor" className="text-muted-foreground" strokeDasharray="4 4" />
              <line x1="0" y1="130" x2="500" y2="130" stroke="currentColor" className="text-muted-foreground" strokeDasharray="4 4" />
          ...
          <div className="flex justify-between text-[11px] font-medium text-muted-foreground pt-3 border-t border-border mt-2">
            <span>Week 1</span>
            <span>Week 2</span>
            <span>Week 3</span>
            <span>Week 4</span>
        ...
        <div className="bg-card p-6 rounded-2xl border border-border/80 shadow-sm flex flex-col justify-between">
          ...
          <div className="relative my-3 flex items-center justify-center">
            <svg className="w-44 h-44 transform -rotate-90" viewBox="0 0 120 120">
              {/* Total Track */}
              <circle cx="60" cy="60" r="46" stroke="currentColor" strokeWidth="11" fill="none" className="text-muted-foreground" />
              {/* Completed Segment */}
            ...
            <div className="absolute flex flex-col items-center justify-center text-center">
              ...
              <span className="text-[10px] text-muted-foreground font-semibold uppercase">Fulfillment Rate</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-xs pt-3 border-t border-border">
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-foreground font-medium">Completed ({poFulfillment.completedPercent}%)</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="w-2.5 h-2.5 rounded-full bg-muted0"></span>
              <span className="text-foreground font-medium">Arrived QA ({poFulfillment.arrivedPercent}%)</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="w-2.5 h-2.5 rounded-full bg-amber-500"></span>
              <span className="text-foreground font-medium">Pending ({poFulfillment.pendingPercent}%)</span>
            </div>
            <div className="flex items-center gap-1.5">
              <span className="w-2.5 h-2.5 rounded-full bg-rose-500"></span>
              <span className="text-foreground font-medium">Rejected ({poFulfillment.rejectedPercent}%)</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card text-foreground p-6 rounded-2xl border border-border/80 shadow-sm space-y-6">
            ...
            {procurementRecs.length > 0 ? (
              <div className="space-y-3">
                {procurementRecs.slice(0, 4).map((rec: any, idx: number) => (
                  <div
                    key={idx}
                    className="p-4 rounded-xl bg-card border border-border space-y-3 shadow-xs hover:border-border transition-colors"
                  >
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center text-xs bg-muted p-2.5 rounded-lg border border-border">
                      <div>
                      ...
                      <div>
                        ...
                        <span className="font-bold text-indigo-600 text-sm mt-0.5 block">{rec.predictedMonthlyUsage}</span>
                      </div>
                      <div>
                        <span className="text-[10px] text-muted-foreground block font-medium">Reorder Qty</span>
                        <span className="font-bold text-emerald-600 text-sm mt-0.5 block">{rec.recommendedReorderQty}</span>
                      </div>
                    </div>

                    <p className="text-[11px] text-foreground italic bg-muted/80 p-2 rounded-lg border border-border/40">
              ...
              <div className="space-y-3">
                {productionRecs.slice(0, 4).map((rec: any, idx: number) => (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-2 text-center text-xs bg-muted p-2.5 rounded-lg border border-border">
                      <div>
                        <span className="text-[10px] text-muted-foreground block font-medium">Suggested Batches</span>
                        <span className="font-bold text-indigo-600 text-sm mt-0.5 block">{rec.recommendedBatchCount} batches</span>
                      </div>
                      <div>
          ...
          {lowStockAlerts.length > 0 ? (
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs">
                <thead>
                  <tr className="border-b border-border text-muted-foreground uppercase text-[10px] font-semibold">
                ...
                <tbody className="divide-y divide-border">
                  {lowStockAlerts.map((item: any, idx: number) => (
                    <tr key={idx} className="hover:bg-muted/50/40">
              ...
              {frequentlyProduced.slice(0, 5).map((prod: any, idx: number) => (
                <div key={idx} className="space-y-1.5">
                  <div className="flex justify-between text-xs font-medium">
                    ...
                    <span className="text-muted-foreground font-mono">{prod.batchCount} batches ({prod.totalOutputQty} units)</span>
                  </div>
                  <div className="w-full h-2 bg-muted rounded-full overflow-hidden">
                    <div
                      className="h-full bg-muted0 rounded-full transition-all duration-300"
                      style={{
